                                <?php echo html::stylesheet('plugins/wikishidi/views/css/user', '', true);?>
				<!--TODO - if you have already signed up sign in here-->
                                <?php
				if ($form_error) {
				?>
					<!-- red-box -->
...
<!--TODO - if you have already signed up verify your account here-->